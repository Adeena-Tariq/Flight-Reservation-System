...
while (true) {
    ...
    cout << RED << "Invalid name. Only letters and spaces, at least 3 characters." << RESET << endl;
}
...
while (true) {
    ...
    cout << RED << "Invalid email format. Try again." << RESET << endl;
}
...
while (true) {
    ...
    cout << RED << "Invalid phone number. Try again." << RESET << endl;
}

// Passport validation
while (true) {
    cout << "Enter passport number (letters and numbers): "; cin.getline(passport, MAX_STR_LEN);
    if (isValidPassport(passport)) break;
    cout << RED << "Invalid passport format. Try again." << RESET << endl;
}

// Address (no validation needed)
...
while (true) {
    ...
    cout << RED << "Invalid date format or past date. Try again." << RESET << endl;
}
...
while (true) {
    ...
    cout << RED << "Invalid time format. Try again." << RESET << endl;
}

// Validate price
while (true) {
    cout << "Enter price: $"; cin >> price;
    if (!cin.fail() && price > 0) break;
    cout << RED << "Invalid price. Enter a positive number." << RESET << endl;
...
while (true) {
    ...
    if (!cin.fail() && seats > 0) break;
    cout << RED << "Invalid seat number. Enter a positive integer." << RESET << endl;
    cin.clear(); cin.ignore(1000, '\n');
}

cin.ignore(); // flush newline after seats input
